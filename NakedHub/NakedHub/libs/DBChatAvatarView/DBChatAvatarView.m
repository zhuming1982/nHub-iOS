...
//    UIImage *img = [self.chatAvatarDataSource imageForAvatarAtIndex:index inChatAvatarView:self];
//    [avatarView setImage:img];
    
    NSURL *imgUrl = [self.chatAvatarDataSource imageUrlForAvatarAtIndex:index inChatAvatarView:self];
...
- (UIColor *)statusColorForState:(DBChatAvatarState)state {
    switch (state) {
        case DBChatAvatarStateOffline: return [UIColor grayColor];
        case DBChatAvatarStateOnline: return [UIColor greenColor];
