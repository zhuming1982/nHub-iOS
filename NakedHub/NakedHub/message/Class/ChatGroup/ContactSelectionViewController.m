...
- (void)viewDidLoad
{
    ...
    self.title = [GDLocalizableClass getStringForKey:@"title.chooseContact"];
...
- (UIView *)footerView
{
    if (_footerView == nil) {
        ...
        [_doneButton setTitle:[GDLocalizableClass getStringForKey:@"accept"] forState:UIControlStateNormal];
        [_doneButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        _doneButton.titleLabel.font = [UIFont systemFontOfSize:14.0];
        [_doneButton setTitle:[GDLocalizableClass getStringForKey:@"ok"] forState:UIControlStateNormal];
...
- (BOOL)searchBarShouldBeginEditing:(UISearchBar *)searchBar
{
    ...
    [self.searchBar setCancelButtonTitle:[GDLocalizableClass getStringForKey:@"ok"]];
...
//        remarkView.image = [UIImage imageNamed:@"chatListCellHead.png"];
    ...
    if ([self.selectedContacts count] == 0) {
        ...
        [_doneButton setTitle:[NSString stringWithFormat:[GDLocalizableClass getStringForKey:@"Done(%i)"], [self.selectedContacts count]] forState:UIControlStateNormal];
    }
}
...
- (void)loadDataSource
{
    [self showHudInView:self.view hint:[GDLocalizableClass getStringForKey:@"loadData"]];
