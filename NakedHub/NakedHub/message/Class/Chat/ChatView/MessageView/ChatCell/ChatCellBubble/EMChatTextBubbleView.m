...
- (void)setModel:(MessageModel *)model
{
    ...
    if (self.model.isSender) {
        ...
        [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor whiteColor] range:NSMakeRange(0, self.model.content.length)];
    }
    else
    {
          [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor blackColor] range:NSMakeRange(0, self.model.content.length)];
    }
...
{
//    return [UIFont fontWithName:@"Avenir-Medium" size:15];
