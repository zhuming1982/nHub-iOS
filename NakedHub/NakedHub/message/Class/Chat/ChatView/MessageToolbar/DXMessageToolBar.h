...
#define kTouchToRecord [GDLocalizableClass getStringForKey:@"message.toolBar.record.touch"]

#define kTouchToFinish [GDLocalizableClass getStringForKey:@"message.toolBar.record.send"]
