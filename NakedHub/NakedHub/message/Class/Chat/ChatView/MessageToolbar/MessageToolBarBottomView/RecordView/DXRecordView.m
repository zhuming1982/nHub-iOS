...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLabel.text = [GDLocalizableClass getStringForKey:@"message.toolBar.record.upCancel"];
...
{
    _textLabel.text = [GDLocalizableClass getStringForKey:@"message.toolBar.record.loosenCancel"];
