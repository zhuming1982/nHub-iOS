...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = [GDLocalizableClass getStringForKey:@"setting.editName"];
...
- (void)setupTextField
{
    ...
    _nickTextField.placeholder = [GDLocalizableClass getStringForKey:@"setting.inputName"];
...
- (void)setupButton
{
    ...
    [_saveButton setTitle:[GDLocalizableClass getStringForKey:@"setting.saveName"] forState:UIControlStateNormal];
...
- (void)setupLabel
{
    ...
    _tipLabel.text =[GDLocalizableClass getStringForKey:@"setting.edittips"];
    CGFloat height = 0;
...
- (void)doSave:(id)sender
{
    if(_nickTextField.text.length > 0)
    {
        ...
        [EMAlertView showAlertWithTitle:[GDLocalizableClass getStringForKey:@"prompt"]
                                message:[GDLocalizableClass getStringForKey:@"setting.namenotempty"]
                        completionBlock:nil
