...
- (UISearchBar *)searchBar
{
    if (_searchBar == nil) {
        ...
        _searchBar.placeholder = [GDLocalizableClass getStringForKey:@"search"];
            ...
            if (loginUsername && loginUsername.length > 0) {
                if ([loginUsername isEqualToString:buddy.username]) {
                    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:[GDLocalizableClass getStringForKey:@"prompt"]
                                message:[GDLocalizableClass getStringForKey:@"friend.notChatSelf"] delegate:nil cancelButtonTitle:[GDLocalizableClass getStringForKey:@"ok"] otherButtonTitles:nil, nil];
                    [alertView show];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        cell.textLabel.text = [GDLocalizableClass getStringForKey:@"title.apply"];
        ...
        if (indexPath.section == 0 && indexPath.row == 1) {
            ...
            cell.username = [GDLocalizableClass getStringForKey:@"title.group"];
        }
        else if (indexPath.section == 0 && indexPath.row == 2) {
            cell.imageView.image = [UIImage imageNamed:@"groupPublicHeader"];
            cell.username =[GDLocalizableClass getStringForKey:@"title.chatroomlist"];
        }
        else if (indexPath.section == 0 && indexPath.row == 3) {
            cell.imageView.image = [UIImage imageNamed:@"groupPublicHeader"];
            cell.username =[GDLocalizableClass getStringForKey:@"title.robotlist"];
        }
        else{
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        if ([buddy.username isEqualToString:loginUsername]) {
            UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:[GDLocalizableClass getStringForKey:@"prompt"] message:[GDLocalizableClass getStringForKey:@"friend.notDeleteSelf"] delegate:nil cancelButtonTitle:[GDLocalizableClass getStringForKey:@"ok"] otherButtonTitles:nil, nil];
            [alertView show];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (loginUsername && loginUsername.length > 0) {
            if ([loginUsername isEqualToString:buddy.username]) {
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:[GDLocalizableClass getStringForKey:@"prompt"] message:[GDLocalizableClass getStringForKey:@"friend.notChatSelf"] delegate:nil cancelButtonTitle:[GDLocalizableClass getStringForKey:@"ok"] otherButtonTitles:nil, nil];
                [alertView show];
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex != actionSheet.cancelButtonIndex && _currentLongPressIndex) {
        ...
        [self hideHud];
        [self showHudInView:self.view hint:[GDLocalizableClass getStringForKey:@"wait"]];
...
- (void)cellImageViewLongPressAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:[GDLocalizableClass getStringForKey:@"cancel"]destructiveButtonTitle:[GDLocalizableClass getStringForKey:@"friend.block"]otherButtonTitles:nil, nil];
