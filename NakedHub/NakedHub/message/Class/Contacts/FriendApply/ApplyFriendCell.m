...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_addButton setTitle:[GDLocalizableClass getStringForKey:@"Accept"] forState:UIControlStateNormal];
        ...
        [_refuseButton setTitle:[GDLocalizableClass getStringForKey:@"Reject"] forState:UIControlStateNormal];
