...
- (void)viewDidLoad
{
    ...
    self.title = [GDLocalizableClass getStringForKey:@"title.apply"];
    ...
    if(self.dataSource.count > indexPath.row)
    {
        ...
        if (entity) {
            ...
            if (applyStyle == ApplyStyleGroupInvitation) {
                ...
                cell.titleLabel.text =[GDLocalizableClass getStringForKey:@"title.groupApply"];
            ...
            else if (applyStyle == ApplyStyleJoinGroup)
            {
                ...
                cell.headerImageView.image = [UIImage imageNamed:@"Avatar"];
            }
...
- (void)applyCellAddFriendAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row < [self.dataSource count]) {
        [self showHudInView:self.view hint:[GDLocalizableClass getStringForKey:@"sendingApply"]];
        ...
        if (!error) {
            ...
            [self showHint:[GDLocalizableClass getStringForKey:@"acceptFail"]];
        }
    }
}
...
- (void)applyCellRefuseFriendAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row < [self.dataSource count]) {
        ...
        if (!error) {
            ...
            [self showHint:[GDLocalizableClass getStringForKey:@"rejectFail"]];
        }
    }
}
